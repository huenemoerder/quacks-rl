...
checkpoint_dir = './checkpoints_colorful_dqn_last_final_final/'
...
for _ in range(num_iterations):
    ...
    if step % eval_interval == 0:
        ...
        pickle.dump(np.array(returns), open('results/dqn_colorful_returns_last_final_final.pkl', 'wb'))
        pickle.dump(np.array(losses), open('results/dqn_colorful_losses_last_final_final.pkl', 'wb'))
